const colors = {
  background: "#000",
  fileEntry: {
    background: `hsl(0deg 30% 100% / 25%)`,
    backgroundFocused: `hsl(0deg 60% 100% / 30%)`,
    backgroundFocusedHover: `hsl(0deg 90% 100% / 35%)`,
    border: "hsl(0deg 30% 100% / 30%)",
    borderFocused: "hsl(0deg 60% 100% / 35%)",
    borderFocusedHover: "hsl(0deg 90% 100% / 40%)",
    text: "#FFF",
    textShadow: `
  ...
  highlight: "hsl(0deg 100% 100% / 90%)",
  highlightBackground: "hsl(0deg 100% 100% / 20%)",
  startButton: "#FFF",
  taskbar: {
